export async function fetchFeed (req) {
	...
	const channels = [
		...
		{ id: 'UCF6JMjE4LM3nuWhaiLjLuOQ', nickname: 'Mapreader', tags: [ 'travel', 'exploration' ] },
		{ id: 'UCdueDRFYPVgzPAAOM_bxVWA', nickname: 'Sidetrack Adventures', tags: [ 'travel', 'exploration' ] },
		{ id: 'UC4nMOYyG1V7LeDIxP4gXAJA', nickname: 'Midnight Kotatsu', tags: [ 'travel', 'Japan' ] },
		{ id: 'UCeQq3LwWnxm-bG1yX-FxgLA', nickname: 'travelgeek', tags: [ 'travel', 'Japan' ] },
		{ id: 'UCWRgjGPIutM9r91dihIyl5Q', nickname: 'New Yorkshire Workshop', tags: [ 'restoration' ] },
		{ id: 'UCqEcM-ZrWoC7AgGDoxi2X-w', nickname: 'Jesper Makes', tags: [ 'woodworking' ] },
		{ id: 'UCZ9jWH_8tJ-Nmaj8dSQdEYA', nickname: 'Stefan Milo', tags: [ 'history', 'education' ] },
		{ id: 'UCuH95ifiMkXSCEj5TEdc_Cw', nickname: 'Shaun Overton | DUSTUPS', tags: [ 'desert', 'education' ] },
		{ id: 'UCrc2iv2-G1FZ3VscM3zu2jg', nickname: 'Lindsay Nikole', tags: [ 'deep time', 'education' ] },
		//{ id: 'UC-SrCCzkGq0wmSAuRs7EBFg', nickname: 'miniminuteman', tags: [ 'deep time', 'education' ] },
		{ id: 'UCjHU3-vf6O9uz39YzY9nQPw', nickname: 'thePOVchannel', tags: [ 'googleearth', 'exploration' ] },
		{ id: 'UC_aOteuWIY8ITg7DQQspG1g', nickname: 'History of the Earth', tags: [ 'cosmology', 'education' ] },
		{ id: 'UCkBaTVM3qU_pGBHPHn8BT6Q', nickname: "Lost Wrench Garage", tags: [ 'corvair', 'restoration' ] },
		{ id: 'UCjNqEdLzfsg4-ZA5yCdq01A', nickname: "Melomotive", tags: [ 'porsche', 'restoration' ] },
